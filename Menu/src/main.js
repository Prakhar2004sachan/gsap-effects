...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const linksHighlighter = document.querySelector(".link-highlighter");
  ...
  gsap.set(linksHighlighter, { y: "150%" });
  ...
  if (defaultLinkText) {
    ...
    linksHighlighter.style.width = linkWidth + "px";
